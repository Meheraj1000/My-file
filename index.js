            ...
            <div>
                <div class=" border rounded-md">
                    ...
                    <div class="flex justify-around pb-2">
                        <div class="">
                            <button onclick="markASRead('${pats.image}')" class=" btn border px-3 py-1 rounded-md bg-[#c070b5]">
                                <img class="w-6" src="https://img.icons8.com/?size=50&id=24816&format=png" alt="">
                            </button>
                        </div>
                        <div><button id="adoptBtn" onclick="adoptPet()" class=" btn border px-3 py-1 rounded-md font-bold bg-[#c070b5]">Adopt</button></div>
                        <div>
                            <button onclick="CardButtonDetail(${pats?.petId})" class=" btn border px-3 py-1 rounded-md font-bold bg-[#c070b5]">Details</button>
                        </div>
                    </div>
                 </div>
             </div>
...
const markASRead = (image) => {
    let markAsReadContainer = document.getElementById('imgCountcard');
    console.log(image);
    ...
    // Add new image div to container
